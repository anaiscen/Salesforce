...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema id22018225_salesforce
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema id22018225_salesforce
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `id22018225_salesforce`;
USE `id22018225_salesforce` ;

-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`company`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`category` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `companyCategoryId`
    ...
    REFERENCES `id22018225_salesforce`.`company` (`id`));


-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`picturestorage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`picturestorage` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`picturestorage` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`idea`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`idea` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`idea` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `categoryId`
    ...
    REFERENCES `id22018225_salesforce`.`category` (`id`)
    ON DELETE RESTRICT,
  CONSTRAINT `pictureid`
    FOREIGN KEY (`pictureId`)
    REFERENCES `id22018225_salesforce`.`picturestorage` (`id`));


-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`commentary`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`commentary` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`commentary` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `ideaCommentaryId`
    ...
    REFERENCES `id22018225_salesforce`.`idea` (`id`)
    ON DELETE CASCADE);


-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`role` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`role` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`subcommentary`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`subcommentary` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`subcommentary` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `commentarySubCommentaryId`
    ...
    REFERENCES `id22018225_salesforce`.`commentary` (`id`));


-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`team`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`team` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`team` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`user` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`user` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `teamUserId`
    FOREIGN KEY (`teamId`)
    REFERENCES `id22018225_salesforce`.`team` (`id`),
  CONSTRAINT `userRoleId`
    FOREIGN KEY (`roleId`)
    REFERENCES `id22018225_salesforce`.`role` (`id`));

-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`usercommentary`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`usercommentary` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`usercommentary` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `liked` TINYINT NULL DEFAULT NULL,
  ...
  CONSTRAINT `userCommentaryUserId`
    FOREIGN KEY (`userId`)
    REFERENCES `id22018225_salesforce`.`user` (`id`));

-- -----------------------------------------------------
-- Table `id22018225_salesforce`.`useridea`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `id22018225_salesforce`.`useridea` ;

CREATE TABLE IF NOT EXISTS `id22018225_salesforce`.`useridea` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
VALUES ('id22018225_salesforce', '10', '2019-12-31', 'Bob', 'bob@mail.com', "0123456789");

INSERT INTO team (`name`, `companyId`)
VALUES ('Admin id22018225_salesforce', 1);

INSERT INTO role (name)
VALUES ('id22018225_salesforce'), ('Admin'), ('Membre'), ('Exclu');
